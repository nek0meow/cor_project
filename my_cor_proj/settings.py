"""
Django settings for my_cor_proj project.
...
SECRET_KEY = 'django-insecure-i6%f81tp(p2%+d%ejiwc1^ehba8yh7a&&jbyv+&vlbg=jhq7md'
...
WSGI_APPLICATION = 'my_cor_proj.wsgi.application'
